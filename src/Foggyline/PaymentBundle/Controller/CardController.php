...
class CardController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $cards = $em->getRepository('FoggylinePaymentBundle:Card')->findAll();

        return $this->render('FoggylinePaymentBundle:default:card/index.html.twig', array(
            'cards' => $cards,
        ));
    }
    ...
    {
        $card = new Card();
        $form = $this->createForm('Foggyline\PaymentBundle\Form\CardType', $card);
        ...
        return $this->render('FoggylinePaymentBundle:default:card/new.html.twig', array(
            'card' => $card,
    ...
    public function showAction(Card $card)
    {
        ...
        return $this->render('FoggylinePaymentBundle:default:card/show.html.twig', array(
            'card' => $card,
    ...
    {
        $deleteForm = $this->createDeleteForm($card);
        $editForm = $this->createForm('Foggyline\PaymentBundle\Form\CardType', $card);
        ...
        return $this->render('FoggylinePaymentBundle:default:card/edit.html.twig', array(
            'card' => $card,
