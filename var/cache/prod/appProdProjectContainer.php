...
class appProdProjectContainer extends Container
{
    ...
    public function __construct()
    {
        ...
        $this->methodMap = array(
            ...
            'bestsellers' => 'getBestsellersService',
            ...
            'category_menu' => 'getCategoryMenuService',
            'checkout_menu' => 'getCheckoutMenuService',
            'config_cache_factory' => 'getConfigCacheFactoryService',
            'controller_name_converter' => 'getControllerNameConverterService',
            'customer_menu' => 'getCustomerMenuService',
    ...
    /*
     * Gets the 'bestsellers' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \AppBundle\Service\Menu\BestSellers A AppBundle\Service\Menu\BestSellers instance.
     */
    protected function getBestsellersService()
    {
        return $this->services['bestsellers'] = new \AppBundle\Service\Menu\BestSellers();
    }
    ...
    {
        $this->services['cache.app'] = $instance = new \Symfony\Component\Cache\Adapter\FilesystemAdapter('uSnmFRB0Hl', '', (__DIR__.'/pools'));
    ...
    {
        return $this->services['cache.system'] = \Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('cDRn2SnQm4', '', 'PMMjQO2WiVZdPws8oDUnUA', (__DIR__.'/pools'), $this->get('monolog.logger.cache', ContainerInterface::NULL_ON_INVALID_REFERENCE));
    }
    ...
    protected function getCacheClearerService()
    {
        ...
        $a->addPool(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('kGBAJdTT6n', '', 'PMMjQO2WiVZdPws8oDUnUA', (__DIR__.'/pools'), $this->get('monolog.logger.cache', ContainerInterface::NULL_ON_INVALID_REFERENCE)));
    ...
    /*
     * Gets the 'category_menu' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \Foggyline\BucketBundle\Service\Menu\Category A Foggyline\BucketBundle\Service\Menu\Category instance.
     */
    protected function getCategoryMenuService()
    {
        return $this->services['category_menu'] = new \Foggyline\BucketBundle\Service\Menu\Category();
    }

    /*
     * Gets the 'checkout_menu' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \AppBundle\Service\Menu\Checkout A AppBundle\Service\Menu\Checkout instance.
     */
    protected function getCheckoutMenuService()
    {
        return $this->services['checkout_menu'] = new \AppBundle\Service\Menu\Checkout();
    }
    ...
    /*
     * Gets the 'customer_menu' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \AppBundle\Service\Menu\Customer A AppBundle\Service\Menu\Customer instance.
     */
    protected function getCustomerMenuService()
    {
        return $this->services['customer_menu'] = new \AppBundle\Service\Menu\Customer();
    }
    ...
    protected function getDoctrineCache_Providers_Doctrine_Orm_DefaultMetadataCacheService()
    {
        ...
        $instance->setNamespace('sf2orm_default_96cbdb04e90dc0b1386937cda4921668a5b366350b7f3a4fa0047ae34017d67d');
    ...
    /*
     * Gets the 'onsale' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \AppBundle\Service\Menu\OnSale A AppBundle\Service\Menu\OnSale instance.
     */
    protected function getOnsaleService()
    {
        return $this->services['onsale'] = new \AppBundle\Service\Menu\OnSale();
    }
    ...
    {
        return $this->services['security.encoder_factory'] = new \Symfony\Component\Security\Core\Encoder\EncoderFactory(array('Symfony\\Component\\Security\\Core\\User\\User' => array('class' => 'Symfony\\Component\\Security\\Core\\Encoder\\BCryptPasswordEncoder', 'arguments' => array(0 => 12))));
    }
    ...
    protected function getSecurity_Firewall_Map_Context_MainService()
    {
        ...
        $f = new \Symfony\Component\HttpFoundation\RequestMatcher('/new');

        $g = new \Symfony\Component\HttpFoundation\RequestMatcher('/edit');

        $h = new \Symfony\Component\HttpFoundation\RequestMatcher('/', NULL, array(0 => 'DELETE'));

        $i = new \Symfony\Component\Security\Http\AccessMap();
        $i->add($f, array(0 => 'ROLE_ADMIN'), NULL);
        ...
        return $this->services['security.firewall.map.context.main'] = new \Symfony\Bundle\SecurityBundle\Security\FirewallContext(array(0 => new \Symfony\Component\Security\Http\Firewall\ChannelListener($i, new \Symfony\Component\Security\Http\EntryPoint\RetryAuthenticationEntryPoint(80, 443), $a), 1 => new \Symfony\Component\Security\Http\Firewall\ContextListener($b, array(0 => $this->get('security.user.provider.concrete.in_memory')), 'main', $a, $this->get('event_dispatcher', ContainerInterface::NULL_ON_INVALID_REFERENCE), $c), 2 => new \Symfony\Component\Security\Http\Firewall\BasicAuthenticationListener($b, $d, 'main', $j, $a), 3 => new \Symfony\Component\Security\Http\Firewall\AnonymousAuthenticationListener($b, '575058449737c2.51666810', $a, $d), 4 => new \Symfony\Component\Security\Http\Firewall\AccessListener($b, $this->get('security.access.decision_manager'), $i, $d)), new \Symfony\Component\Security\Http\Firewall\ExceptionListener($b, $c, new \Symfony\Component\Security\Http\HttpUtils($e, $e), 'main', $j, NULL, NULL, $a, false));
    }
    ...
    protected function getTwigService()
    {
        ...
        $instance->addGlobal('category_menu', $this->get('category_menu'));
        $instance->addGlobal('customer_menu', $this->get('customer_menu'));
        $instance->addGlobal('checkout_menu', $this->get('checkout_menu'));
        $instance->addGlobal('products_bestsellers', $this->get('bestsellers'));
        $instance->addGlobal('products_onsale', $this->get('onsale'));
    ...
    protected function getTwig_LoaderService()
    {
        ...
        $instance->addPath(($this->targetDirs[3].'/src/Foggyline/BucketBundle/Resources/views'), 'FoggylineBucket');
    ...
    {
        return $this->services['uri_signer'] = new \Symfony\Component\HttpKernel\UriSigner('be9738120bedad5971beccd09d423b2550668b95');
    }
    ...
    {
        return $this->services['cache.validator'] = \Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('o0iQBVrwDQ', '', 'PMMjQO2WiVZdPws8oDUnUA', (__DIR__.'/pools'), $this->get('monolog.logger.cache', ContainerInterface::NULL_ON_INVALID_REFERENCE));
    }
    ...
    protected function getSecurity_User_Provider_Concrete_InMemoryService()
    {
        ...
        $instance->createUser(new \Symfony\Component\Security\Core\User\User('alice', '$2y$12$wvdE1Fjb29hgY6//g/khuedLq3wQOuLbZ/tYqzxI9PfIfBF24fEfa', array(0 => 'ROLE_USER')));
        $instance->createUser(new \Symfony\Component\Security\Core\User\User('john', '$2y$12$DFozWehwPkp14sVXr7.IbusW8ugvmZs9dQMExlggtyEa/TxZUStnO', array(0 => 'ROLE_ADMIN')));
    ...
    protected function getDefaultParameters()
    {
        return array(
            ...
            'kernel.bundles' => array(
                ...
                'FoggylineBucketBundle' => 'Foggyline\\BucketBundle\\FoggylineBucketBundle',
            ),
            'kernel.charset' => 'UTF-8',
            'kernel.container_class' => 'appProdProjectContainer',
            'database_host' => '127.0.0.1',
            'database_port' => NULL,
            'database_name' => 'symfony_shop',
            'database_user' => 'root',
            ...
            'secret' => 'be9738120bedad5971beccd09d423b2550668b95',
            'locale' => 'en',
            'fragment.renderer.hinclude.global_template' => NULL,
            'fragment.path' => '/_fragment',
            'kernel.secret' => 'be9738120bedad5971beccd09d423b2550668b95',
            ...
            'validator.mapping.cache.prefix' => 'validator_fee8b3085fe930417937c98d798173564a51f499e09c080cc25334a99687f6b7',
